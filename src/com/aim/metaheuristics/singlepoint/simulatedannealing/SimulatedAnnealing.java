...
public class SimulatedAnnealing extends SinglePointSearchMethod {
	 ...
	 *       Everything else is handled by the framework/Lab4ExercisesRunner.
	 * ================================================================
	 * 
	...
	protected void runMainLoop() {
		...
		// TODO implement a single pass of Simulated Annealing - don't forget to update the temperature (see oCoolingSchedule).
	}
