 ...
 *
 */
public class Lab4ExercisesTestFrameConfig extends TestFrameConfig {
	 ...
	 */
	protected final int TRIALS_PER_TEST = 31;
	 ...
	 * 
	 */
	private static Lab4ExercisesTestFrameConfig oThis;

	/**
	 * 
	 */
	private Lab4ExercisesTestFrameConfig() {
	 ...
	 * @return
	 */
	public synchronized static Lab4ExercisesTestFrameConfig getInstance() {

		if (oThis == null) {
			oThis = new Lab4ExercisesTestFrameConfig();
		}
