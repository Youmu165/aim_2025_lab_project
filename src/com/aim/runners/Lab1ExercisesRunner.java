...
/**
 * Class for running the experiment(s) in Lab 1.
 *
...
public class Lab1ExercisesRunner extends TestFrame {
	...
	public Lab1ExercisesRunner() {
		...
		super(Lab1ExercisesTestFrameConfig.getConfig());
	}
	 ...
	 * @param instance The instance of the problem to be solved (See Framework API)
	 * @param timeLimit The nominal time limit/budget.
	 * @return
	 */
