...
public class Lab2ExercisesRunner extends TestFrame {
	...
	public Lab2ExercisesRunner(Lab2ExercisesTestFrameConfig config) {
	...
	public void runTests() {
		...
		BoxChart oChart = XBoxPlot.getPlotCreator().createPlot(BOXPLOT_TITLE, "Heuristic", "Objective Value", oPlotData);
	...
	public RunData runExperiment(int run, int heuristicId) {
		...
		SATHeuristic heuristic = Lab2ExercisesTestFrameConfig.getSATHeuristic(heuristicId, random);
	...
	public static void main(String[] args) {
		...
		Lab2ExercisesTestFrameConfig config = Lab2ExercisesTestFrameConfig.getInstance();
		TestFrame runner = new Lab2ExercisesRunner(config);
		runner.runTests();
	}
}
